...
goog.provide('proto.tensorflow.serving.InferenceResult');

goog.require('jspb.Message');
goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('proto.tensorflow.serving.ClassificationResult');
...
proto.tensorflow.serving.InferenceResult.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    classificationResult: (f = msg.getClassificationResult()) && proto.tensorflow.serving.ClassificationResult.toObject(includeInstance, f),
    regressionResult: (f = msg.getRegressionResult()) && proto.tensorflow.serving.RegressionResult.toObject(includeInstance, f)
  };
...
proto.tensorflow.serving.InferenceResult.prototype.getClassificationResult = function() {
  return /** @type{?proto.tensorflow.serving.ClassificationResult} */ (
    jspb.Message.getWrapperField(this, proto.tensorflow.serving.ClassificationResult, 2));
};
...
proto.tensorflow.serving.InferenceResult.prototype.getRegressionResult = function() {
  return /** @type{?proto.tensorflow.serving.RegressionResult} */ (
    jspb.Message.getWrapperField(this, proto.tensorflow.serving.RegressionResult, 3));
};
