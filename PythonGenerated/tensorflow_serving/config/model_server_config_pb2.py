...
_MODELCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='version_policy', full_name='tensorflow.serving.ModelConfig.version_policy', index=4,
...
_MODELCONFIG.fields_by_name['version_policy'].enum_type = tensorflow__serving_dot_sources_dot_storage__path_dot_file__system__storage__path__source__pb2._FILESYSTEMSTORAGEPATHSOURCECONFIG_VERSIONPOLICY
