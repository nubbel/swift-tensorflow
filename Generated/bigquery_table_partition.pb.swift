...
struct Tensorflow_BigQueryTablePartition: SwiftProtobuf.Message {
  static let protoMessageName: String = _protobuf_package + ".BigQueryTablePartition"
...
extension Tensorflow_BigQueryTablePartition: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func _protobuf_generated_isEqualTo(other: Tensorflow_BigQueryTablePartition) -> Bool {
