...
public struct Tensorflow_RewriterConfig: SwiftProtobuf.Message {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if _storage._memoryOptimization != Tensorflow_RewriterConfig.MemOptType.noMemOpt {
...
extension Tensorflow_RewriterConfig: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _memoryOptimization: Tensorflow_RewriterConfig.MemOptType = Tensorflow_RewriterConfig.MemOptType.noMemOpt
