...
public struct Tensorflow_OptimizerOptions: SwiftProtobuf.Message {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.optLevel != Tensorflow_OptimizerOptions.Level.l1 {
    ...
    if self.globalJitLevel != Tensorflow_OptimizerOptions.GlobalJitLevel.`default` {
...
extension Tensorflow_RunOptions: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    var _traceLevel: Tensorflow_RunOptions.TraceLevel = Tensorflow_RunOptions.TraceLevel.noTrace
