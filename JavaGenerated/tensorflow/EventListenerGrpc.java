...
public final class EventListenerGrpc {
  ...
  private static final class EventListenerDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    @java.lang.Override
      ...
      synchronized (EventListenerGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              .setSchemaDescriptor(new EventListenerDescriptorSupplier())
              .addMethod(METHOD_SEND_EVENTS)
              .build();
        }
      }
    }
