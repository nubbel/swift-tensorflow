...
public final class Learner {
  ...
  public  static final class LearnerConfig extends
    ...
    public enum PruningMode
      ...
      /**
       * <code>PRE_PRUNE = 0;</code>
       */
      PRE_PRUNE(0),
      /**
       * <code>POST_PRUNE = 1;</code>
       */
      POST_PRUNE(1),
      UNRECOGNIZED(-1),
      ;
       ...
       * <code>PRE_PRUNE = 0;</code>
       */
      public static final int PRE_PRUNE_VALUE = 0;
      /**
       * <code>POST_PRUNE = 1;</code>
       */
      public static final int POST_PRUNE_VALUE = 1;
      ...
      public static PruningMode forNumber(int value) {
        switch (value) {
          case 0: return PRE_PRUNE;
          case 1: return POST_PRUNE;
          default: return null;
        }
      }
    ...
    public enum GrowingMode
       ...
       * <code>WHOLE_TREE = 0;</code>
       */
      public static final int WHOLE_TREE_VALUE = 0;
      /**
       * <pre>
       * Layer by layer is only supported by the batch learner.
       * </pre>
       ...
       * <code>LAYER_BY_LAYER = 1;</code>
       */
      public static final int LAYER_BY_LAYER_VALUE = 1;
      ...
      public static GrowingMode forNumber(int value) {
        switch (value) {
          case 0: return WHOLE_TREE;
          case 1: return LAYER_BY_LAYER;
          default: return null;
        }
      }
    ...
    public enum MultiClassStrategy
        implements com.google.protobuf.ProtocolMessageEnum {
      /**
       * <code>TREE_PER_CLASS = 0;</code>
       */
      TREE_PER_CLASS(0),
      /**
       * <code>FULL_HESSIAN = 1;</code>
       */
      FULL_HESSIAN(1),
      /**
       * <code>DIAGONAL_HESSIAN = 2;</code>
       */
      DIAGONAL_HESSIAN(2),
      UNRECOGNIZED(-1),
      ;
       ...
       * <code>TREE_PER_CLASS = 0;</code>
       */
      public static final int TREE_PER_CLASS_VALUE = 0;
      /**
       * <code>FULL_HESSIAN = 1;</code>
       */
      public static final int FULL_HESSIAN_VALUE = 1;
      /**
       * <code>DIAGONAL_HESSIAN = 2;</code>
       */
      public static final int DIAGONAL_HESSIAN_VALUE = 2;
      ...
      public static MultiClassStrategy forNumber(int value) {
        switch (value) {
          case 0: return TREE_PER_CLASS;
          case 1: return FULL_HESSIAN;
          case 2: return DIAGONAL_HESSIAN;
          default: return null;
        }
      }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (pruningMode_ != tensorflow.boosted_trees.learner.Learner.LearnerConfig.PruningMode.PRE_PRUNE.getNumber()) {
        output.writeEnum(8, pruningMode_);
      }
      if (growingMode_ != tensorflow.boosted_trees.learner.Learner.LearnerConfig.GrowingMode.WHOLE_TREE.getNumber()) {
        output.writeEnum(9, growingMode_);
      }
      if (multiClassStrategy_ != tensorflow.boosted_trees.learner.Learner.LearnerConfig.MultiClassStrategy.TREE_PER_CLASS.getNumber()) {
  ...
  static {
    ...
    internal_static_tensorflow_boosted_trees_learner_TreeConstraintsConfig_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_tensorflow_boosted_trees_learner_TreeConstraintsConfig_descriptor,
        new java.lang.String[] { "MaxTreeDepth", "MinNodeWeight", });
    internal_static_tensorflow_boosted_trees_learner_LearningRateConfig_descriptor =
