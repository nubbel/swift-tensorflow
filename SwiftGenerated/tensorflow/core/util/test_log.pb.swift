  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1, 2:
        ...
        self.kind = try Tensorflow_EntryValue.OneOf_Kind(byDecodingFrom: &decoder, fieldNumber: fieldNumber)
      default: break
      }
    }
  }
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1, 2:
        ...
        self.kind = try Tensorflow_CommitId.OneOf_Kind(byDecodingFrom: &decoder, fieldNumber: fieldNumber)
...
public struct Tensorflow_TestResults: SwiftProtobuf.Message {
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if _storage._benchmarkType != Tensorflow_TestResults.BenchmarkType.unknown {
...
extension Tensorflow_EntryValue.OneOf_Kind {
...
extension Tensorflow_CommitId.OneOf_Kind {
  fileprivate init?<T: SwiftProtobuf.Decoder>(byDecodingFrom decoder: inout T, fieldNumber: Int) throws {
    switch fieldNumber {
    case 1:
      var value = Int64()
...
extension Tensorflow_TestResults: SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  fileprivate class _StorageClass {
    ...
    var _benchmarkType: Tensorflow_TestResults.BenchmarkType = Tensorflow_TestResults.BenchmarkType.unknown
