...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  const ::google::protobuf::Descriptor* PredictRequest_InputsEntry_descriptor = protobuf_tensorflow_5fserving_2fapis_2fpredict_2eproto::file_level_metadata[0].descriptor;
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
        PredictRequest_InputsEntry_descriptor,
        ::google::protobuf::internal::MapEntry<
            ...
            0>::CreateDefaultInstance(
                PredictRequest_InputsEntry_descriptor));
  const ::google::protobuf::Descriptor* PredictResponse_OutputsEntry_descriptor = protobuf_tensorflow_5fserving_2fapis_2fpredict_2eproto::file_level_metadata[2].descriptor;
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
        PredictResponse_OutputsEntry_descriptor,
        ::google::protobuf::internal::MapEntry<
            ::std::string,
            ::tensorflow::TensorProto,
            ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
...
const ::google::protobuf::Descriptor* PredictRequest::descriptor() {
  protobuf_tensorflow_5fserving_2fapis_2fpredict_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_tensorflow_5fserving_2fapis_2fpredict_2eproto::file_level_metadata[1].descriptor;
}
...
::google::protobuf::Metadata PredictRequest::GetMetadata() const {
  protobuf_tensorflow_5fserving_2fapis_2fpredict_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_tensorflow_5fserving_2fapis_2fpredict_2eproto::file_level_metadata[1];
}
...
const ::google::protobuf::Descriptor* PredictResponse::descriptor() {
  protobuf_tensorflow_5fserving_2fapis_2fpredict_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_tensorflow_5fserving_2fapis_2fpredict_2eproto::file_level_metadata[3].descriptor;
}
...
::google::protobuf::Metadata PredictResponse::GetMetadata() const {
  protobuf_tensorflow_5fserving_2fapis_2fpredict_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_tensorflow_5fserving_2fapis_2fpredict_2eproto::file_level_metadata[3];
}
