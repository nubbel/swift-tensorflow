...
class StaticStoragePathSourceConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.StaticStoragePathSourceConfig) */ {
 public:
  ...
  inline StaticStoragePathSourceConfig* New() const PROTOBUF_FINAL { return New(NULL); }

  StaticStoragePathSourceConfig* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
